...
public class ClientCoapMessageTranslator implements CoapMessageTranslator {
    ...
    public List<Resource> createResources(CoapServer coapServer, ServerIdentityExtractor extractor,
        ...
        for (Integer objectId : objectTree.getObjectEnablers().keySet()) {
            resources.add(createObjectResource(objectId, extractor, receiver, toolbox));
        }
        ...
        objectTree.addListener(new ObjectsListenerAdapter() {
            ...
            public void objectAdded(LwM2mObjectEnabler object) {
                CoapResource clientObject = createObjectResource(object.getId(), extractor, receiver, toolbox);
    ...
    public CoapResource createObjectResource(int objectId, ServerIdentityExtractor identityExtractor,
            LwM2mRequestReceiver requestReceiver, ClientEndpointToolbox toolbox) {
        return new ObjectResource(objectId, identityExtractor, requestReceiver, toolbox);
    }
}

...
public class ClientRequestReceiver implements LwM2mRequestReceiver {

    private RegistrationEngine registrationEngine;
    private final BootstrapHandler bootstrapHandler;
    private final LwM2mRootEnabler rootEnabler;
    private final LwM2mObjectTree objectTree;

    public ClientRequestReceiver(BootstrapHandler bootstrapHandler, LwM2mRootEnabler rootEnabler,
    ...
    public void setRegistratioEngine(RegistrationEngine registrationEngine) {
